...
An interactive digital piano prototype with a light pastel blue design, inspired by The ONE keyboard. Each key plays a unique piano sound using high-quality multisampled audio.

## Features

- **Realistic piano sounds**: Uses [@tonejs/piano](https://github.com/tambien/Piano) with Salamander Grand Piano samples (Yamaha C5)
- **Unique sound per key**: Each of the 37 keys has its own sampled note
- **Visual feedback**: Keys glow red/pink when pressed
- **22 white keys + 15 black keys**: 3 octaves (C3–C6)

## Setup

Uses [Tone.js](https://tonejs.github.io/) and [@tonejs/piano](https://github.com/tambien/Piano) for audio. Run `npm install` to install dependencies.
